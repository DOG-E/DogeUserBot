...
async def process(msg, user, client, reply, replied=None):
    ...
    font = ImageFont.truetype(
        "userbot/helpers/styles/Roboto_Medium.ttf", 43, encoding="utf-16"
    )
    font2 = ImageFont.truetype(
        "userbot/helpers/styles/Roboto_Regular.ttf", 33, encoding="utf-16"
    )
    mono = ImageFont.truetype(
        "userbot/helpers/styles/DroidSansMono.ttf", 30, encoding="utf-16"
    )
    italic = ImageFont.truetype(
        "userbot/helpers/styles/Roboto_Italic.ttf", 33, encoding="utf-16"
    )
    fallback = ImageFont.truetype(
        "userbot/helpers/styles/Quivira.otf", 43, encoding="utf-16"
    )
    ...
    if replied:
        ...
        canvas.paste(middle, (pfpbg.width, top.height))
        canvas.paste(bottom, (pfpbg.width, top.height + middle.height))
        canvas = await dogedoctype(docname, docsize, doctype, canvas)
        y = 80 if text else 0
    else:
        canvas.paste(pfpbg, (0, 0))
        canvas.paste(top, (pfpbg.width, 0))
    ...
    textfallback = ImageFont.truetype(
        "userbot/helpers/styles/Quivira.otf", 33, encoding="utf-16"
    )
    textcolor = "white"
    for line in text:
        for letter in line:
            ...
            for offset, length in bold.items():
                if index in range(offset, length):
                    font2 = ImageFont.truetype(
                        "userbot/helpers/styles/Roboto_Medium.ttf",
                        33,
                        encoding="utf-16",
                    )
                    textcolor = "white"
            for offset, length in italic.items():
                if index in range(offset, length):
                    font2 = ImageFont.truetype(
                        "userbot/helpers/styles/Roboto_Italic.ttf",
                        33,
                        encoding="utf-16",
                    )
                    textcolor = "white"
            for offset, length in mono.items():
                if index in range(offset, length):
                    font2 = ImageFont.truetype(
                        "userbot/helpers/styles/DroidSansMono.ttf",
                        30,
                        encoding="utf-16",
                    )
                    textcolor = "white"
            for offset, length in link.items():
                if index in range(offset, length):
                    font2 = ImageFont.truetype(
                        "userbot/helpers/styles/Roboto_Regular.ttf",
                        30,
                        encoding="utf-16",
                    )
                    textcolor = "#898989"
...
async def fontTest(letter):
    test = TTFont("userbot/helpers/styles/Roboto-Medium.ttf")
...
async def dogedoctype(name, size, htype, canvas):
    font = ImageFont.truetype("userbot/helpers/styles/Roboto_Medium.ttf", 38)
...
async def no_photo(reply, tot):
    ...
    font = ImageFont.truetype("userbot/helpers/styles/Roboto_Regular.ttf", 60)
...
async def emoji_fetch(emoji):
    emojis = json.loads(
        urllib.request.urlopen(
            "https://github.com/DOG-E/Source/raw/DOGE/Core/emojis.txt"
        )
        .read()
        .decode()
    )
...
async def replied_user(draw, tot, text, maxlength, title):
    namefont = ImageFont.truetype("userbot/helpers/styles/Roboto_Medium.ttf", 38)
    namefallback = ImageFont.truetype("userbot/helpers/styles/Quivira.otf", 38)
    textfont = ImageFont.truetype("userbot/helpers/styles/Roboto_Regular.ttf", 32)
    textfallback = ImageFont.truetype("userbot/helpers/styles/Roboto_Medium.ttf", 38)
