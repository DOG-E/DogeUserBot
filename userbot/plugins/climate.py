...
from . import WEATHER_API, _format, doge, eor, gvar, logging, reply_id, sgvar
...
async def get_weather(event):  # sourcery no-metrics
    ...
    url = (
        f"https://api.openweathermap.org/data/2.5/weather?q={CITY}&appid={(gvar('WEATHER_API') or '6fded1e1c5ef3f394283e3013a597879')}"
    )
