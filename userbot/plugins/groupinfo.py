...
from . import BOTLOG, BOTLOG_CHATID, doge, edl, eor, get_chatinfo, logging, reply_id
...
async def get_users(show):
    ...
    if input_str:
        ...
        try:
            ...
            return await edl(show, f"`{e}`")
    elif not show.is_group:
        return await edl(show, "`Are you sure this is a group?`")
