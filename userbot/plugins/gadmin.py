...
async def doggban(event):  # sourcery no-metrics
    "To ban user in every group where you're admin."
...
async def doggban(event):
    "To unban the person from every group where you're admin."
...
async def startgmute(event):
    "To mute a person in all groups where you're admin."
    if event.is_private:
...
async def doggkick(event):  # sourcery no-metrics
    "kicks the person in all groups where you're admin"
