...
async def _(event):  # sourcery no-metrics
    ...
    if input_str == "msg":
        ...
        if gamee:
            return await edl(event, "`This Group is locked with sending games`")
        if not ugamee:
            return await edl(
        ...
        if gpoll:
            return await edl(event, "`This Group is locked with sending polls`")
        if not ugpoll:
            return await edl(
