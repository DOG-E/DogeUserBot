...
from wand.image import Image as dogeimage
...
async def dog_meme(CNG_FONTS, topString, bottomString, filename, endname):
...
async def dog_meeme(upper_text, lower_text, CNG_FONTS, picture_name, endname):
    main_image = dogeimage(filename=picture_name)
    main_image.resize(
