...
async def fontTest(letter):
    test = TTFont("dogebot/helpers/styles/Roboto-Medium.ttf")
...
async def dogedoctype(name, size, htype, canvas):
    font = ImageFont.truetype("dogebot/helpers/styles/Roboto_Medium.ttf", 38)
...
async def no_photo(reply, tot):
    ...
    font = ImageFont.truetype("dogebot/helpers/styles/Roboto_Regular.ttf", 60)
...
async def replied_user(draw, tot, text, maxlength, title):
    namefont = ImageFont.truetype("dogebot/helpers/styles/Roboto_Medium.ttf", 38)
    namefallback = ImageFont.truetype("dogebot/helpers/styles/Quivira.otf", 38)
    textfont = ImageFont.truetype("dogebot/helpers/styles/Roboto_Regular.ttf", 32)
    textfallback = ImageFont.truetype("dogebot/helpers/styles/Roboto_Medium.ttf", 38)
