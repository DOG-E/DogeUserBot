...
async def fakegs(search, result):
    ...
    blue = (0, 0, 255)
    black = (0, 0, 0)
    font1 = ImageFont.truetype("dogebot/helpers/styles/otherfonts/Productsans_BoldItalic.ttf", 20)
    font2 = ImageFont.truetype("dogebot/helpers/styles/ProductSans_Light.ttf", 23)
