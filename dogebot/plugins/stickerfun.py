...
@doge.doge_cmd(
    ...
    info={
        ...
        "usage": [
            "{tr}rgb <text>",
            "{tr}rgb <font file name> ; <text>",
        ],
        "examples": "{tr}rgb hello",
    },
)
async def sticklet(event):
    ...
    fontsize = 230
    FONT_FILE = await get_font_file(event.client, "@DogeFont", font_file_name)
    ...
    await event.client.send_file(
        event.chat_id,
        image_stream,
        caption="@DogeUserbot's Sticklet",
