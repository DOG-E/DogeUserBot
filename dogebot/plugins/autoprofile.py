...
autopic_path = os.path.join(os.getcwd(), "dogebot", "original_pic.png")
digitalpic_path = os.path.join(os.getcwd(), "dogebot", "digital_pic.png")
autophoto_path = os.path.join(os.getcwd(), "dogebot", "photo_pfp.png")
...
async def digitalpicloop():
    ...
    while DIGITALPICSTART:
        ...
        img = Image.open(autophoto_path)
        drawn_text = ImageDraw.Draw(img)
        dog = str(base64.b64decode("ZG9nZWJvdC9oZWxwZXJzL3N0eWxlcy9kaWdpdGFsLnR0Zg=="))[
            2:36
        ]
...
async def _(event):  # sourcery no-metrics
    ...
    if input_str == "spam":
        if gvarstatus("spamwork") is not None and gvarstatus("spamwork") == "true":
            delgvar("spamwork")
            return await edit_delete(event, "`Spam has been stopped now`")
