...
@doge.doge_cmd(
    ...
    info={
        ...
        "note": "For langugage codes check [this link](https://telegra.ph/LANGUAGE-CODES-07-01)",
        "usage": [
...
@doge.doge_cmd(
    ...
    info={
        ...
        "description": "Check here [Language codes](https://telegra.ph/LANGUAGE-CODES-07-01)",
        "options": {
